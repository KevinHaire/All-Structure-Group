<div class="contain pageContainer">
	...
	<p>At All Structure Group LTD. we believe that we have a specialized project management system tailored to our industry that lets us become totally accountable for a project from start to finish. A few examples of how we’ve created such a system include:</p>
	<ul>
		<li>Safety: This is number one in our company</li>
		<li>All Structure Group LTD. has a corporate safety policy dedicated specifically to our scope of work</li>
		<li>We own our fleet of GPS monitored vehicles</li>
		<li>Owning our own lift equipment for erection</li>
		<li>Owning our own mobile offices and storage units</li>
		...
		<li>8 years total experience in steel erection and pre-engineered building industry</li>
